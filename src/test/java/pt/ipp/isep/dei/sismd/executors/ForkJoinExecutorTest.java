...
class ForkJoinExecutorTest {
    ...
    void apply() {
        ...
        Image forkjoinResult = new ForkJoinExecutor(brighter).apply(image);
        assertTrue(Arrays.deepEquals(sequentialResult.getPixelMatrix(), forkjoinResult .getPixelMatrix()));
    }
}